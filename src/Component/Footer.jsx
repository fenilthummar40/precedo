            ...
            <section className='pt-10 bg-slate-900'>
                <div className='max-w-7xl mx-auto bg-cover bg-center px-5'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-10'>
                        <div>
                            <p className='text-gray-400 font-normal text-sm lg:text-lg line-clamp-2'>Contrary to popular
                            ...
                            <div className='flex items-center gap-5 mt-5'>
                                <span
                                    className='border rounded-full border-gray-600 flex items-center justify-center p-2 text-white hover:bg-gradient-to-r from-purple-600 to-pink-500 cursor-pointer'><IconBrandTwitter/></span>
                                <span
                                    className='border rounded-full border-gray-600 flex items-center justify-center p-2 text-white hover:bg-gradient-to-r from-purple-600 to-pink-500 cursor-pointer'><IconBrandFacebook/></span>
                                <span
                                    className='border rounded-full border-gray-600 flex items-center justify-center p-2 text-white hover:bg-gradient-to-r from-purple-600 to-pink-500 cursor-pointer'><IconBrandInstagram/></span>
                                <span
                                    className='border rounded-full border-gray-600 flex items-center justify-center p-2 text-white hover:bg-gradient-to-r from-purple-600 to-pink-500 cursor-pointer'><IconBrandGit/></span>
                            </div>
                        </div>
                        ...
                        <div>
                            <ul className='flex items-center flex-wrap gap-4 md:gap-8'>
                                <li><a
                                    className='text-white font-normal text-sm md:text-lg hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-500 hover:bg-clip-text hover:text-transparent'
                                    href="">Home</a></li>
                                <li><a
                                    className='text-white font-normal text-sm md:text-lg hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-500 hover:bg-clip-text hover:text-transparent'
                                    href="">About Us</a></li>
                    ...
                    <div className='mt-5 border border-gray-600 rounded-t-lg p-2 grid grid-cols-1 md:grid-cols-2 '>
                        <div><p className='text-gray-400 font-normal text-sm md:text-lg'>© 2024 Precedo All Rights
                            Reserved by site </p></div>
